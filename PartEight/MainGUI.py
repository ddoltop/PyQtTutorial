...
"}")
        ...
        self.lineEdit_bookid.setMinimumSize(QtCore.QSize(0, 35))
...
"}")
        ...
        self.lineEdit_memberid.setMinimumSize(QtCore.QSize(0, 35))
        ...
        self.lineEdit_submission.setMinimumSize(QtCore.QSize(0, 35))
...
"}")
        ...
        self.tableWidget_bookinfo.horizontalHeader().setDefaultSectionSize(180)
        ...
        self.toolButton_viewbooks = QtWidgets.QToolButton(self.centralwidget)
        self.toolButton_viewbooks.setMaximumSize(QtCore.QSize(145, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.toolButton_viewbooks.setFont(font)
        icon5 = QtGui.QIcon()
        ...
        self.toolButton_viewbooks.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        self.toolButton_viewbooks.setObjectName("toolButton_viewbooks")
        self.verticalLayout.addWidget(self.toolButton_viewbooks)
        self.toolButton_viewmembers = QtWidgets.QToolButton(self.centralwidget)
        self.toolButton_viewmembers.setMaximumSize(QtCore.QSize(145, 16777215))
        font = QtGui.QFont()
        font.setPointSize(14)
        self.toolButton_viewmembers.setFont(font)
        icon6 = QtGui.QIcon()
        ...
        self.toolButton_viewmembers.setIconSize(QtCore.QSize(68, 68))
        self.toolButton_viewmembers.setToolButtonStyle(QtCore.Qt.ToolButtonStyle.ToolButtonTextUnderIcon)
        self.toolButton_viewmembers.setObjectName("toolButton_viewmembers")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.lineEdit_submission.setPlaceholderText(_translate("MainWindow", "Please Enter Issue ID"))
        ...
        self.toolButton_viewbooks.setText(_translate("MainWindow", "View Books"))
        self.toolButton_viewmembers.setText(_translate("MainWindow", "View Members"))
